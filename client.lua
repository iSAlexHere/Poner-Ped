...
RegisterNetEvent('reventaos:userpeds:spawnPed')
AddEventHandler('reventaos:userpeds:spawnPed', function()
	ESX.TriggerServerCallback('reventaos:userpeds:pedCheck', function(result)
		if result ~= nil then
			spawnped(result)
		end		
	end)
...
RegisterCommand('ponerped', function()
	ESX.TriggerServerCallback('reventaos:userpeds:pedCheck', function(result)
		if result ~= nil then
			spawnped(result)
		end		
	...
	if pedmodel ~= nil then
		...
		if IsModelValid(Model) then
			...
			if not tonumber(results.randomized) then
				...
				TriggerServerEvent('reventaos:userpeds:saveRandomized')
			else
